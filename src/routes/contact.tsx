...
export const Route = createFileRoute("/contact")({
  head: () => ({ meta: [{ title: "Contact Us" }, { name: "description", content: "Get in touch with our customer support team." }] }),
  component: Contact,
});
...
function Contact() {
  ...
  const items = [
    { i: Phone, l: "Call us", v: settings.whatsapp_number },
    { i: MessageCircle, l: "WhatsApp", v: settings.whatsapp_number },
    { i: Mail, l: "Email", v: settings.email },
    { i: MapPin, l: "Address", v: "Karachi, Pakistan" },
  ];
  return (
    <SiteLayout>
